...
const PRECACHE_URLS = [
  '/winmail-viewer/',
  '/winmail-viewer/manifest.json',
  '/winmail-viewer/icon-192.png',
  '/winmail-viewer/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/winmail-viewer/manifest.json';
}
