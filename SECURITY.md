...
`winmail-viewer` runs entirely in your browser. There is no server component and no
account system, so the files you open are never uploaded. Most classic web vulnerabilities
...
- The TNEF parser, the service worker, and the PWA manifest.
